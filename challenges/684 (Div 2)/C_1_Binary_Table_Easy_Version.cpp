          ...
          if ((i + 1) < n && (j + 1) < m) {
            if (arr[i][j] == '1' && arr[i][j + 1] == '1' &&
              ...
              ans.pb(tt);
                       ...
                       arr[i + 1][j] == '1' && arr[i + 1][j + 1] == '0') {
              arr[i][j + 1] = '0', arr[i + 1][j] = '0', arr[i + 1][j + 1] = '1';
              vi tt{i, j + 1, i + 1, j, i + 1, j + 1};
              ans.pb(tt);
            } else if (arr[i][j] == '1' && arr[i][j + 1] == '0' &&
                       arr[i + 1][j] == '0' && arr[i + 1][j + 1] == '1') {
              arr[i][j] = '0', arr[i][j + 1] = '1', arr[i + 1][j + 1] = '0';
              vi tt{i, j, i, j + 1, i + 1, j + 1};
              ans.pb(tt);
            }
          }
