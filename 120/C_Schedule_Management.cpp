...
signed main() {
  ...
  while (t--) {
    ...
    auto ok = [&](int x) {
      ...
      for (int i = 1; i <= n && task > 0; i++) {
        for(auto j : mp) {
          
        }
        // every second i can do at max N work
        // i will put every worker on work every second efficiently
        // on the basis of priority
        // those with given builder and free will get it.
      }
    };
