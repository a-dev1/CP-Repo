...
signed main() {
  ...
  // for permutation you broke n into n-x and found the ans for that
  // but for combination you have to kept the count unique
  // instead of breaking we will see what will be the contribution of each coin
  // throughout each sum
  for (int i = 0; i < n; i++) {
    for (int j = 1; j <= x; j++) {
